	...
	return (
		...
		>
			...
			{!isLastItemForTheDay && !showMedals && (
				<div
					className={classNames('absolute top-[28px] left-[11px] h-full border-solid border-l-[1px]')}
			...
			>
				...
				>
					...
					<div
						className="hidden sm:flex items-center justify-between relative"
					...
					{showFocusNotes && (
						<div
							className={classNames(
								'text-color-gray-100 text-[16px] break-words react-markdown relative z-10 mt-3',
								limitTextWidth && 'max-w-[54ch]'
							)}
							style={{ color: cardTextColor }}
						>
					...
					{showCompletedTasks && thereAreCompletedTasks && (
						<div className="relative z-10">
							<h3 className="text-[16px] font-bold underline mt-4" style={{ color: cardTextColor }}>
								Completed Tasks
							</h3>

							<ul className={classNames(limitTextWidth && 'max-w-[54ch]')}>
