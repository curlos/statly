 ...
 * @returns {Object}
 */
export const getGroupedSubtasksAndParentTasks = ({ completedTasksForDay, ancestorTasksById }: { completedTasksForDay: (Task | AncestorTask)[]; ancestorTasksById: Record<string, Task | AncestorTask> }) => {
