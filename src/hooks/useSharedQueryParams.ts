...
export const useSharedQueryParams = () => {
	...
	return {
		...
		queryParams: {
			...
			'search-case-sensitive': searchParams.get('search-case-sensitive') || '',
			'search-whole-word': searchParams.get('search-whole-word') || '',
			'search-match-all': searchParams.get('search-match-all') || '',
			'search-regex': searchParams.get('search-regex') || '',
